...
export class deleteEntity1ById {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          bh = await this.sd_9D17XwjE3U8tpWUP(bh);
          //appendnew_next_sd_HVd71LgxCPSmT8m1
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_HVd71LgxCPSmT8m1');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_9D17XwjE3U8tpWUP(bh) {
    try {
      this.sdService.addDMPropertiesToBh(bh, bh.web.req, 'entity_1');
      bh = await this.sd_7RDqw2GW6Qab0Ope(bh);
      //appendnew_next_sd_9D17XwjE3U8tpWUP
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_9D17XwjE3U8tpWUP');
    }
  }

  async sd_7RDqw2GW6Qab0Ope(bh) {
    try {
      ...
      //appendnew_next_sd_7RDqw2GW6Qab0Ope
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_7RDqw2GW6Qab0Ope');
    }
  }
  ...
  async sd_IpUaU51q741upXgr(bh) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_W6POAFxbgzbCZwvf');
    }
  }
