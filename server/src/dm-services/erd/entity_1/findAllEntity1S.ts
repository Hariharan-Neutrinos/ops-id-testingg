...
export class findAllEntity1S {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_wkRA0588PZblDM44
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_wkRA0588PZblDM44');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_0grguYfj00JSLkeH(bh) {
    try {
      ...
      bh = await this.sd_XGwt53IoZeEZhOC0(bh);
      //appendnew_next_sd_0grguYfj00JSLkeH
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_d51nX5ijhUYY4qJX');
    }
  }

  async sd_XGwt53IoZeEZhOC0(bh) {
    try {
      ...
      //appendnew_next_sd_XGwt53IoZeEZhOC0
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_XGwt53IoZeEZhOC0');
    }
  }
  ...
  async sd_IpUaU51q741upXgr(bh) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_9b2kOV2IpNiaUlym');
    }
  }
