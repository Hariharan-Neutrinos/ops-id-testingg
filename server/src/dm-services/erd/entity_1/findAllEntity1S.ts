...
export class findAllEntity1S {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_OH4SXwU5AJM3eSnO
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_OH4SXwU5AJM3eSnO');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_0grguYfj00JSLkeH(bh) {
    try {
      ...
      bh = await this.sd_E6Q1W94en23dT9Af(bh);
      //appendnew_next_sd_0grguYfj00JSLkeH
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_AnnGJ1ChR7KEYQ4H');
    }
  }

  async sd_E6Q1W94en23dT9Af(bh) {
    try {
      ...
      //appendnew_next_sd_E6Q1W94en23dT9Af
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_E6Q1W94en23dT9Af');
    }
  }
  ...
  async sd_IpUaU51q741upXgr(bh) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_hv4N3EWfz2P7Zp5X');
    }
  }
