...
export class findAllEntity1S {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_BpbrHN8KLuzX6ToP
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_BpbrHN8KLuzX6ToP');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_0grguYfj00JSLkeH(bh) {
    try {
      ...
      bh = await this.sd_1WidGsIHxboNnDmg(bh);
      //appendnew_next_sd_0grguYfj00JSLkeH
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_oGdyhLMQUSWSuxTa');
    }
  }

  async sd_1WidGsIHxboNnDmg(bh) {
    try {
      ...
      //appendnew_next_sd_1WidGsIHxboNnDmg
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_1WidGsIHxboNnDmg');
    }
  }
  ...
  async sd_IpUaU51q741upXgr(bh) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_ML4Kb3TtjHCMOxGT');
    }
  }
