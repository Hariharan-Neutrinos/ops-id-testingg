...
export class createAllEntity1 {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_TSUuJmla0sESTmRJ
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_TSUuJmla0sESTmRJ');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_0grguYfj00JSLkeH(bh) {
    try {
      ...
      bh = await this.sd_QB38kwkwJQZ9g23R(bh);
      //appendnew_next_sd_0grguYfj00JSLkeH
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_TsqtzwghUrnrBorl');
    }
  }

  async sd_QB38kwkwJQZ9g23R(bh) {
    try {
      ...
      //appendnew_next_sd_QB38kwkwJQZ9g23R
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_QB38kwkwJQZ9g23R');
    }
  }
  ...
  async sd_IpUaU51q741upXgr(bh) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_KgkOCMlxaO1oUzAh');
    }
  }
