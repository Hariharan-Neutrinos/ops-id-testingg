...
export class createEntity1 {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_HW0NNlRAFvZSe5MO
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_HW0NNlRAFvZSe5MO');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_0grguYfj00JSLkeH(bh) {
    try {
      ...
      bh = await this.sd_K3pDZ5nmMLiw2bfb(bh);
      //appendnew_next_sd_0grguYfj00JSLkeH
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_S0VQhP2IeCnGlcO4');
    }
  }

  async sd_K3pDZ5nmMLiw2bfb(bh) {
    try {
      ...
      //appendnew_next_sd_K3pDZ5nmMLiw2bfb
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_K3pDZ5nmMLiw2bfb');
    }
  }
  ...
  async sd_IpUaU51q741upXgr(bh) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_ZvkAWUOMe9LQPnz6');
    }
  }
