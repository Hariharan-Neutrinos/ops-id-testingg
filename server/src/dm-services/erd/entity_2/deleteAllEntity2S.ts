...
export class deleteAllEntity2S {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          bh = await this.sd_roVKYDDxc5YKvtc9(bh);
          //appendnew_next_sd_ou9efgd7axkJFhaz
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_ou9efgd7axkJFhaz');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_roVKYDDxc5YKvtc9(bh) {
    try {
      this.sdService.addDMPropertiesToBh(bh, bh.web.req, 'entity_2');
      bh = await this.sd_U6BIrRlR3eKU2sx8(bh);
      //appendnew_next_sd_roVKYDDxc5YKvtc9
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_roVKYDDxc5YKvtc9');
    }
  }

  async sd_U6BIrRlR3eKU2sx8(bh) {
    try {
      ...
      //appendnew_next_sd_U6BIrRlR3eKU2sx8
      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_U6BIrRlR3eKU2sx8');
    }
  }
  ...
  async sd_IpUaU51q741upXgr(bh) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_8akolQPywQ1lFU2j');
    }
  }
